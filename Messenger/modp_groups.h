...
static const modp_group modp_groups[] = {
    { "modp1", group_modp1, sizeof(group_modp1), two_generator, 1 },
    { "modp2", group_modp2, sizeof(group_modp2), two_generator, 1 },
    { "modp5", group_modp5, sizeof(group_modp5), two_generator, 1 },
    { "modp14", group_modp14, sizeof(group_modp14), two_generator, 1 },
    { "modp15", group_modp15, sizeof(group_modp15), two_generator, 1 },
    { "modp16", group_modp16, sizeof(group_modp16), two_generator, 1 },
    { "modp17", group_modp17, sizeof(group_modp17), two_generator, 1 },
    { "modp18", group_modp18, sizeof(group_modp18), two_generator, 1 }
};
